...
class TViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        squareView1.frame = CGRect(x: 150, y: 200, width: 100, height: 100)
        squareView1.backgroundColor = .purple
        UIView().drawLayer(to: squareView1)
        
        squareView2.frame = CGRect(x: 50, y: 300, width: 100, height: 100)
        squareView2.backgroundColor = .purple
        UIView().drawLayer(to: squareView2)
        
        squareView3.frame = CGRect(x: 150, y: 300, width: 100, height: 100)
        squareView3.backgroundColor = .purple
        UIView().drawLayer(to: squareView3)
        
        squareView4.frame = CGRect(x: 250, y: 300, width: 100, height: 100)
        squareView4.backgroundColor = .purple
